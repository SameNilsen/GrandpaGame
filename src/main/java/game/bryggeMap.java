...
public class bryggeMap implements game.Map{

    Image img = new Image(getClass().getResourceAsStream("res/bryggeMap.png"), 1000, 1000, false, false);
    double maxWidth;
    double maxHeight;
    int hboxsize = 60;
    int waves = 1;
    ...
    public bryggeMap(double width, double heigth) {
        this.maxWidth = width;
