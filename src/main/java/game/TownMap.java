...
public class TownMap implements game.Map{

    Image img = new Image(getClass().getResourceAsStream("res/townMap.png"), 1000, 1000, false, false);
    double maxWidth;
    double maxHeight;
    int hboxsize = 60;
    int waves = 1;
    ...
    public TownMap(double width, double heigth) {
        this.maxWidth = width;
